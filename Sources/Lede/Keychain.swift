...
enum Keychain {
    ...
    enum Key {
        ...
        static let githubClientID = "github.oauth.client_id"
        static let githubAccess = "github.oauth.access"
        static let gmailClientID = "gmail.client_id"
        ...
        static let outlookClientID = "outlook.client_id"
        static let outlookTenant = "outlook.tenant"
