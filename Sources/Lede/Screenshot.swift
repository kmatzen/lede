...
enum Screenshot {
    ...
    static func render(to outURL: URL) {
        ...
        engine.sourceStates = [
            "github:demo:github":         SourceState(lastFetchedAt: Date(), lastItemCount: 3, lastError: nil),
            "google:demo:gmail":          SourceState(lastFetchedAt: Date(), lastItemCount: 2, lastError: nil),
            "slack:demo:slack":           SourceState(lastFetchedAt: Date(), lastItemCount: 1, lastError: nil),
            "google:demo:calendar":       SourceState(lastFetchedAt: Date(), lastItemCount: 1, lastError: nil),
        ]
    ...
    private static func mockDigest() -> Digest {
        ...
        let items: [Digest.Item] = [
            .init(contentHash: "mock-1", source: .slack,
                  accountID: nil, accountLabel: nil,
